        ...
        <ul class="turn-page">
            ...
            <template v-else>
                <template v-if="nowPage < 5">
                    <li v-for="i in 6" :key="i" :class="{'now-page': i == nowPage}" @click="turnPage(i)"></li>
                </template>
                <template v-if="nowPage >= 5">
                 ...
                 <template v-if="nowPage >= 5 && nowPage <= totalPage - 4">
                    <li v-for="i in 5" :key="i" :class="{'now-page':i == 3}"></li>
                </template>
                ...
                <template v-if="nowPage > totalPage - 4">
                    <li v-for="i in 6" :key="i" :class="{'now-page': totalPage - 6 + i == nowPage}" @click="turnPage(totalPage - 6 + i)">{{totalPage - 6 + i}}</li>
                </template>
            </template>
